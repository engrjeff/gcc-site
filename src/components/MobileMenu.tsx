...
function MobileMenu() {
  ...
  return (
    <nav className='h-14 w-full bg-slate-900 fixed bottom-0 left-0 z-10 shadow-md border-t border-slate-800 md:hidden'>
      <ul className='flex'>
          ...
          <li key={linkItem.label} className='flex-1'>
            <Link
              ...
              className={cn(
                ...
                isActive(linkItem.path) ? "text-indigo-400" : "text-slate-400"
              )}
            >
