...
function Footer() {
  return (
    <footer className='bg-slate-900 text-white border-t border-slate-800 text-sm'>
      <div className='container mx-auto max-w-6xl flex py-16'>
        <ul className='space-y-3'>
          ...
          <li className='flex items-center gap-2 text-slate-400'>
            ...
            <span>Phone: </span>
            <a href='tel:+639212882165' className='text-white'>
              <span>+639212882165</span>
            </a>
          </li>
          <li className='flex md:items-center gap-2 text-slate-400'>
      ...
      <div className='py-16 border-t border-slate-800 text-center'>
