...
function MediaListItem(props: MediaListItemProps) {
  ...
  return (
    <div className='flex md:items-center gap-4 lg:gap-10 px-2 md:px-4 py-2 hover:bg-slate-800 rounded-lg group'>
      <span className='text-xl lg:text-2xl font-bold text-slate-600'>
      ...
      <div className='space-y-1 md:space-y-2'>
        ...
        <div className='flex md:items-center flex-col md:flex-row text-xs md:text-sm text-slate-300'>
          <p>{subtitle}</p>
          {subtitle2 ? (
            <>
